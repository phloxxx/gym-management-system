...
// Check page access for staff roles
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="firstName" name="USER_FNAME" class="form-input w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none" value="<?php echo htmlspecialchars($_SESSION['firstname'] ?? ''); ?>" required>
                            </div>
                            
                            <!-- Last Name -->
                            <div>
                                <label for="lastName" class="block text-sm font-medium text-gray-700 mb-1">Last Name</label>
                                <input type="text" id="lastName" name="USER_LNAME" class="form-input w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none" value="<?php echo htmlspecialchars($_SESSION['lastname'] ?? ''); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" id="username" name="USERNAME" class="form-input w-full px-4 py-2 border border-gray-200 rounded-md bg-gray-100 text-gray-500 focus:outline-none cursor-not-allowed" value="<?php echo htmlspecialchars($_SESSION['username'] ?? ''); ?>" readonly>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" id="userType" name="USER_TYPE" class="form-input w-full px-4 py-2 border border-gray-200 rounded-md bg-gray-100 text-gray-500 focus:outline-none cursor-not-allowed" value="Staff" readonly>
                                    <div class="absolute inset-y-0 right-3 flex items-center pointer-events-none">
                                    </div>
                                </div>
                            </div>
