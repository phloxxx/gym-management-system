        ...
        <div class="h-full px-3 py-4 overflow-hidden text-white relative flex flex-col sidebar-content">
            ...
            <nav class="flex-grow relative">
                <ul class="space-y-1 font-medium">
                    ...
                    <!-- Transaction -->
                    <li class="mt-2">
                        <a href="manage-transaction.html" class="sidebar-menu-item">
        ...
        <div class="container mx-auto px-4 py-4">
                ...
                <div class="flex flex-col md:flex-row justify-between md:items-center gap-4">
                    ...
                    <div class="flex gap-3">
                        <button class="bg-primary-dark text-white px-4 py-2 rounded-md hover:bg-opacity-90 transition-colors flex items-center">
                            <i class="fas fa-plus mr-2"></i> <a href="manage-members.html">Add Member</a>
                        </button>
                        <button class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300 transition-colors flex items-center">
                            <i class="fas fa-download mr-2"></i> <a href="generate-reports.html">Generate Reports</a>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-5 lg:col-span-3">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="manage-members.html" class="text-sm text-primary-light hover:underline">View All</a>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead>
                                <tr>
                                    <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-3/5">Member</th>
                                    <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-1/5">Program</th>
                                    <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-1/5">Joined</th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">Strength Training</td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">May 12, 2023</td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">Cardio</td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">May 10, 2023</td>
                                </tr>
                                <tr>
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">Yoga</td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">May 8, 2023</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-5 mb-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="manage-transaction.html" class="text-sm text-primary-light hover:underline">View All</a>
                </div>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-3/5">Transaction</th>
                                <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-1/5">Amount</th>
                                <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-1/5">Date</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr>
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-sm font-medium text-green-600">+$49.99</td>
                                <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">May 12, 2023</td>
                            </tr>
                            <tr>
                                <td class="px-4 py-4 whitespace-nowrap">
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-sm font-medium text-green-600">+$499.99</td>
                                <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">May 10, 2023</td>
                            </tr>
                            <tr>
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-8 w-8 bg-red-100 rounded-full flex items-center justify-center text-red-600 text-xs">EP</div>
                                        <div class="ml-3">
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-sm font-medium text-red-600">-$1,200.00</td>
                                <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">May 8, 2023</td>
                            </tr>
                        </tbody>
                    </table>
